...
export function Editarcampeonato({nombrecamp, fecinicamp, fecfincamp, orgcamp, lugarcamp, numequipcamp, premioscamp, logocamp}){
    ...
    <>
        <button
            ...
            data-bs-target={`#modal_editar_${nombrecamp.replace(/[ .]+/g,'').toLowerCase()}`}
            >
                    ...
                    <form
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text"  className="form-control" id="organizador_evento" placeholder="Organizador del evento" required ref={orgcampe} defaultValue ={orgcamp}/>
                                <div className="invalid-feedback">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text"  className="form-control" id="lugar_evento" placeholder="Lugar del evento" required ref={lugarcampe} defaultValue ={lugarcamp}/>
                                <div className="invalid-feedback">
                            ...
                            <div className="form-group">
                                ...
                                <input type="number"  className="form-control" id="num_equipos" placeholder="Número de equipos" required ref={numequipcampe} defaultValue ={numequipcamp}/>
                                <div className="invalid-feedback">
